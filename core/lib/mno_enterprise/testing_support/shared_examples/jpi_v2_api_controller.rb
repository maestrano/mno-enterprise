module MnoEnterprise::TestingSupport::SharedExamples::JpiV2ApiController
  RSpec.shared_context 'v2 api controller requests context' do
  ...
  RSpec.shared_examples MnoEnterprise::Jpi::V2::ApiController do |only_actions|
    ...
    describe 'CRUD actions' do
      if only_actions.blank? || only_actions.include?(:index)
      ...
      if only_actions.blank? || only_actions.include?(:show)
      ...
      if only_actions.blank? || only_actions.include?(:create)
      ...
      if only_actions.blank? || only_actions.include?(:update)
      ...
      if only_actions.blank? || only_actions.include?(:destroy)
