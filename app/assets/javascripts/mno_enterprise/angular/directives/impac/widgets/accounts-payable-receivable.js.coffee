module = angular.module('maestrano.impac.widgets.accounts.payable-receivable',['maestrano.assets'])
  ...
  ($scope, ImpacDashboardingSvc, ImpacChartFormatterSvc) ->
    ...
    w.format = ->
      if $scope.isDataFound
        ...
        w.chart = ImpacChartFormatterSvc.lineChart(lineData,lineOptions, true)
