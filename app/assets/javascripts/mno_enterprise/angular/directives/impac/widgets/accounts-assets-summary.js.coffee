module = angular.module('maestrano.impac.widgets.accounts.assets-summary',['maestrano.assets'])
...
module.controller('WidgetAccountsAssetsSummaryCtrl',[
  ...
  ($scope, ImpacDashboardingSvc, ImpacChartFormatterSvc) ->
    ...
    $scope.getAccountColor = (anAccount) ->
      ImpacChartFormatterSvc.getColor(_.indexOf(w.content.summary, anAccount)) if $scope.isDataFound
