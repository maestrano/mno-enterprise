...
module MnoEnterprise
  RSpec.describe Jpi::V1::OrganizationsController, type: :routing do
    ...
    it "routes to #update_main_address" do
      expect(put("/jpi/v1/organizations/1/update_main_address")).to route_to("mno_enterprise/jpi/v1/organizations#update_main_address",id: '1')
    end
