...
module MnoEnterprise
  describe Jpi::V1::AppInstancesController, type: :controller do
    ...
    describe 'GET #index' do
      ...
      before { stub_api_v2(:get, '/app_instances', [app_instance], [:app, :owner], {filter: {owner_id: organization.id, status: MnoEnterprise::AppInstance::ACTIVE_STATUSES}}) }
      ...
      describe 'all' do
        it {
          ...
          assert_requested(:get, api_v2_url('/app_instances', [:app, :owner], {filter: {owner_id: organization.id, status: MnoEnterprise::AppInstance::ACTIVE_STATUSES}}))
        }
      end
