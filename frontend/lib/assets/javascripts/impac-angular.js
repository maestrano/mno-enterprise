...
(function () {
'use strict';
angular.module('impac.services.chart-formatter', []).service('ChartFormatterSvc', ["ImpacTheming", "$filter", function(ImpacTheming, $filter) {
